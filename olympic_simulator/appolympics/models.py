...
class Clubtitleregister(models.Model):
    club_title_id = models.BigAutoField(primary_key=True)
    club = models.ForeignKey(Clubs, models.DO_NOTHING)      
...
class Playertitleregister(models.Model):
    ol_title_id = models.BigAutoField(primary_key=True)
    ol_player = models.ForeignKey(Olympicplayers, models.DO_NOTHING)      
    title_label = models.CharField(max_length=300)  
    title_year = models.CharField(max_length=4)
    title_bracket = models.JSONField()
...
class Sportsrecords(models.Model):
    ...
    sport_sort = models.CharField(max_length=2)
    team_sport = models.ForeignKey('Teamsports', models.DO_NOTHING)
...
class Teamtitleregister(models.Model):
    team_title_id = models.BigAutoField(primary_key=True)
    team = models.ForeignKey(Nationalteams, models.DO_NOTHING)      
    title_label = models.CharField(max_length=300)  
    title_year = models.CharField(max_length=4)
    title_bracket = models.JSONField()
