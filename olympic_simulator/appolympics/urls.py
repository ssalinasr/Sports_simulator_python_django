...
urlpatterns = [
    ...
    path('import/results_import_champions/', pagina_importar_campeones, name='pagina_importar_campeones'),
    ...
    path('export/tournament_export/load', exportar_word, name='exportar_word')
    ]
